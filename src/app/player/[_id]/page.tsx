...
const Player: React.FC = () => {
  ...
  const [positions, setPositions] = useState<PositionInterface[]>([]); // Fixed: array, not object
  ...
  const getDetails = useCallback(async () => {
    ...
    try {
      ...
      if (!response.ok) {
        const data = await response.json();
        throw new Error(data.msg || "Failed to fetch player details");
      }
      const data = await response.json();
      setDetails(data);
    } catch (error) {
            ...
            <tr className="table-row">
              ...
              <td className="table-cell">
                {edit ? (
                  ...
                  <span>
                    <Link className="link" href={`/${details.club.name}`}>
                      {details?.club?.name}
                    </Link>
                  </span>
                )}
            ...
            <tr className="table-row">
              ...
              <td className="table-cell">
                {edit ? (
                  ...
                  <span>{details?.position?.name || "N/A"}</span>
                )}
              </td>
            </tr>
          </tbody>
